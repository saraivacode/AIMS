...
> **Example JSONs:** `DNN_FedAvg.json`, `LSTM_Krum.json`, `GRU_TrimmedMean.json`
...
python main.py --security --security-sensitivity-epochs \
    --federated-only --experiment-id "ch8-security" \
    --csv ../data/aims_dataset.csv
```
...
**Models:** DNN, LSTM, GRU
**Research question:** How do label-flip and gradient scaling attacks affect vehicular FL? Are Krum and TrimmedMean effective defenses? What is the impact of local epochs on robustness?
...
| **8** | `0150_cap8_seguranca.tex` | `--security`, `--security-sensitivity-epochs` | DNN, LSTM, GRU | 72 | `phase1a_summary.csv`, `phase1b_summary.csv`, `*_c2a_*.png`, `sensitivity_epochs.png` |
| | | **TOTAL** | | **~90 + 3 HPO** | **~154 artifacts per run** |
